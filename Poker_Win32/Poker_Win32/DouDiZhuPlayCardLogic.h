...
namespace DouDiZhu
{
	...
	private:
		...
		*/
		...
		return:成功返回true，失败返回false。异常抛出
		*/
		bool FindMainCards(const int *sortArray, const int sortArrLen, const int adjacentCount, const int sameCount, const bool isSplit, vector<int*> &outSortArrVec);
		/*
		...
		*/
		...
		bool FindCards(const int *sortArray, const int sortArrLen, const vector<CardNumber> cardNums, const int cardCount, const int subsidiaryCount, const int subsidiarySameCount, const bool isSplit, vector<vector<int>> &outCards);
		bool FindCards(const int *sortArray, const int sortArrLen, const CardNumber cardNum, const int cardCount, const int subsidiaryCount, const int subsidiarySameCount, const bool isSplit, vector<vector<int>> &outCards);
